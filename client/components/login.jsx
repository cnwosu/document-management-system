...
// import { UserLogin } from '../temp/user.js';
...
class Login extends Component {
  ...
  validateUser(event) {
    ...
    const url = `${window.location.href}api/users/login`;
    const options = {
      method: 'POST',
      headers: {
      ...
      <div className="row">
        <div className="col s8 offset-s2">
          ...
          <Row>
            <Col s={6}>
              {(!this.state.isNewUser)
                ? <Button waves="light" onClick={this.validateUser}>Login</Button>
                : <Button waves="light" onClick={this.setSignup}>Signin</Button>
              }
              {(this.state.isNewUser)
                ? <Button waves="light" onClick={this.registerUser}>Register</Button>
                : <Button waves="light" id="signup_button" onClick={this.setSignup}>Signup</Button>
              }
            </Col>
          </Row>
        </div>
